...
legend(0.15,6200,legend = c("lambda = 1","lambda = 3","lambda = 5"),col = c("red","blue","green"),lty = 1,cex = 0.75)
legend(0.15,3000,legend = c("alpha = 3","beta = 2"),cex = 0.75)
```
...
legend(0.3,6200,legend = c("beta = 1","beta = 3","beta = 5"),col = c("red","blue","green"),lty = 1,cex = 0.75)
legend(0.3,3000, legend = c("lambda = 5","alpha = 3"),cex = 0.75)
```
